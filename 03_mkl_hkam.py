...
if __name__ == "__main__":
    ...
    for task_index in task_index_list:
        ...
        train_kernel_save_filename = 'intermediate_results/%s/%s_train_kernel_hkam.npy'%(task_index, task_index)
        test_kernel_save_filename = 'intermediate_results/%s/%s_test_kernel_hkam.npy'%(task_index, task_index)
