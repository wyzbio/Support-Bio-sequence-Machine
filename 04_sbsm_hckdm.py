...
if __name__ == "__main__":
    ...
    for task_index in task_index_list:
        ...
        for para_index in para_index_list:
            ...
            #------------ kernel ------------#
            train_kernel_filename = 'intermediate_results/%s/%s_train_kernel_hckdm%s_com.npy'%(str(task_index), str(task_index), str(para_index))
            test_kernel_filename = 'intermediate_results/%s/%s_test_kernel_hckdm%s_com.npy'%(str(task_index), str(task_index), str(para_index))
            ...
            save_filename = 'experimental_results/%s/%s_result_%s%s.txt'%(task_index, task_index, tag, para_index)
