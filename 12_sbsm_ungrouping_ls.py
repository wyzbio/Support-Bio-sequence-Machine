...
if __name__ == "__main__":
    ...
    for task_index in task_index_list:
        ...
        for fold_index in fold_index_list:
            ...
            #------------ kernel ------------#
            train_kernel_filename = 'intermediate_results/%s/%s_train_kernel_ug_cv%s_%s.npy'%(str(task_index), str(task_index), fold_index, tag)
            test_kernel_filename = 'intermediate_results/%s/%s_test_kernel_ug_cv%s_%s.npy'%(str(task_index), str(task_index), fold_index, tag)
