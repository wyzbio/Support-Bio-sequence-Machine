...
from _MKL_HCKDM_old_version import HCKDM
...
if __name__ == "__main__":
    ...
    for task_index in task_index_list:
        ...
        weight = [0.2236068, 0.2236068, 0.2236068, 0.2236068, 0.2236068, 0.2236068, 0.2236068
...
, 0.2236068, 0.2236068, 0.2236068, 0.2236068, 0.2236068, 0.2236068]
        ...
        train_kernel_save_filename = 'intermediate_results/%s/%s_train_kernel_mean.npy'%(task_index, task_index)
        test_kernel_save_filename = 'intermediate_results/%s/%s_test_kernel_mean.npy'%(task_index, task_index)
