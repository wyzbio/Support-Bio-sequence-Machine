...
if __name__ == "__main__":
    ...
    for task_index in task_index_list:
        ...
        for dict_index in range(len(dictionaries)):
            ...
            #------------ similarity ------------#
            train_kernel = np.array(compute_smithwaterman_train_kernel(replaced_sample_train, process_num))
            test_kernel = np.array(compute_smithwaterman_test_kernel(replaced_sample_test, replaced_sample_train, process_num))
